...
\section{Représentation d'un entier par une forme quadratique.}
...
$\bullet$ $f$ représente l'entier $n \in \mathbb{Z}^*$ s'il existe $(x,y) \in \mathbb{Z}^2$ tel que $f(x,y)=n$.

$\bullet$ $f$ représente 0 s'il existe $(x,y) \in \mathbb{Z}^2$ tel que $f(x,y)=0$ et $(x,y)\neq (0,0)$.

$\bullet$ $f$ représente primitivement $n\in \mathbb{Z}$ si de plus $x\wedge y = 1$.
\end{dfn}
...
Si on restreint cette application au groupe $\mathrm{GL}_2(\mathbb{Z})$ (groupe des matrices à coefficients entiers de déterminant $\pm1$), ou à son sous-groupe $\mathrm{SL}_2(\mathbb{Z})$ (groupe des matrices de déterminant $+1$), (i) et (ii) signifient que ces groupes opèrent sur l'ensemble ${\cal Q}(\mathbb{Z}^2)$.
...
Nous avons prouvé :
 ...
 \begin{dfn}
$\bullet$ Si $D \geq 0$, on désigne par $\mathrm{Cl}(D)$ l'ensemble des classes d'équivalence propre de formes de discriminant $D$, et $\mathrm{P}(D)$ l'ensemble des classes d'équivalence propre de formes primitives.

$\bullet$ Si $D<0$, on désigne par $\mathrm{Cl}(D)$ l'ensemble des classes d'équivalence propre de formes positives de discriminant $D$, et $\mathrm{P}(D)$ l'ensemble des classes d'équivalence propre de formes positives  primitives de discriminant $D$.
...
\end{proof}
 ...
 Un entier $n \in \mathbb{Z}$ est primitivement représenté par la forme $f$ si et seulement s'il existe $b,c \in \mathbb{Z}$ tels que $f \overset{+}{\sim} (n,b,c)$ et $-\vert n \vert < b \leq \vert n \vert$ si $n\neq 0$.
 \end{prop}
 \begin{proof}
 ...
 $\bullet$ si $n=0$, $g \overset{+}{\sim} (0,b',c')$, et le lemme est démontré dans ce cas.
 ...
 \begin{proof}
 (i) $\Rightarrow$ (ii) : déjà prouvé (proposition \ref{completion}).
 
 (ii) $ \Rightarrow$ (i) : soit $f$ une forme de discriminant $D$ qui représente primitivement $n$. D'après la proposition \ref{clef}, $f \overset{+}{\sim} (n,b,c)$ pour des entiers $b,c\in \mathbb{Z}$, donc $\mathrm{disc}(f) = b^2 - 4nc$ est un carré modulo $4n$.
 \end{proof}
 ...
 Inversement, si $D\equiv 0,1\ [4]$, alors $D$ est le discriminant d'au poins une forme :
 $$
\left\{
\begin{array}{lc}
...
\begin{proof}
 ...
 La forme principale représente $1$, et donc aussi les formes équivalentes à la forme principale.
...
Ainsi pour calculer $\mathrm{Cl}(D)$ pour $D<0$ donné, il suffit de déterminer le nombre de triplets $(a,b,c) \in \Z^3$ définissant une forme réduite de discriminant $D$. Pour chaque $b \in \Z$ vérifiant $b \equiv D \pmod 2$ et  $b\ \leq \sqrt{\frac{-D}{3}}$, on factorisera $\frac{b^2 - D}{4}$ sous la forme $ac$ avec $|b| \leq a \leq c$.
 ...
 \section{Représentation d'un nombre premier par la forme $x^2 + 5y^2$.}
